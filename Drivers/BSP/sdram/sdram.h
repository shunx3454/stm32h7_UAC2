...
#define SDRAM_Size (uint32_t)(SDRAM_SIZE)  //16M字节
#define SDRAM_BANK_ADDR     ((uint32_t)SDRAM_BASE_ADDR) 				// FMC SDRAM 数据基地址
...
uint8_t SDRAM_Test(uint32_t BaseAddr, uint32_t size);	// SDRAM读写测试
